...
@Component({
  ...
  styleUrl: './consulat.component.css'
})
export class ConsulatComponent implements OnInit, OnDestroy {
  consulats: any[] = [];
  citoyens: any[] = [];
  ...
  changeItemsPerPageconsulats(event: Event): void {
    ...
    this.currentPageconsulats = 1; // Reset to the first page
    this.updateTotalPagesconsulats();
    this.paginateconsulats();
  }
  ...
  private setupChart(): void {
    ...
    this.zone.runOutsideAngular(() => {
      const root: am5.Root = am5.Root.new("consulatChartDiv");
